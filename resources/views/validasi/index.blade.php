                        ...
                        <tbody x-data="{ expanded: false, beratGudang: '', beratLapangan: {{ $row['total_berat'] }} }" class="border-b border-gray-100">
                            <tr class="bg-white hover:bg-gray-50 transition-colors group cursor-pointer">
                                ...
                                <td class="px-6 py-4 text-center font-bold">
                                    ...
                                    <span x-show="beratGudang !== ''" :class="{'text-red-600': Math.abs(parseFloat(beratGudang || 0) - beratLapangan) > 10, 'text-yellow-600': Math.abs(parseFloat(beratGudang || 0) - beratLapangan) > 0 && Math.abs(parseFloat(beratGudang || 0) - beratLapangan) <= 10, 'text-green-600': Math.abs(parseFloat(beratGudang || 0) - beratLapangan) === 0}" x-text="(parseFloat(beratGudang || 0) - beratLapangan > 0 ? '+' : '') + (parseFloat(beratGudang || 0) - beratLapangan).toFixed(2) + ' kg'"></span>
                                </td>
