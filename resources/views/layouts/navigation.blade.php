<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-white border-r border-gray-200 shadow-lg lg:translate-x-0 lg:static lg:inset-auto flex flex-col justify-between">
    ...
    <div>
        ...
        <nav class="mt-6 px-4 space-y-2">
            ...
            <a href="{{ route('dokumentasi.index') }}" class="flex items-center px-4 py-3 rounded-r-full {{ request()->routeIs('dokumentasi.*') ? 'bg-green-50 text-green-700 font-bold border-l-4 border-green-600' : 'text-gray-500 hover:bg-green-50 hover:text-green-700 transition-colors' }}">
            ...
            @if(Auth::user()->role === 'penimbang' || Auth::user()->role === 'admin')
            ...
            <p class="px-4 pt-4 pb-2 text-xs font-bold text-gray-400 uppercase tracking-wider">4. Pusat Bantuan</p>
