            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-gray-100 p-6 lg:p-8">
                ...
                <form action="{{ route('nasabah.update', $nasabah->id_nasabah) }}" method="POST" x-data="nasabahForm()">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $nasabah->nama) }}" class="w-full border-gray-300 focus:border-green-500 focus:ring focus:ring-green-200 rounded-lg shadow-sm transition-colors" required>
