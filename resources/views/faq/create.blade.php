                ...
                <form action="{{ route('faq.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="pertanyaan" value="{{ old('pertanyaan') }}" required placeholder="Contoh: Bagaimana cara menabung sampah?" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring focus:ring-green-200 shadow-sm">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="jawaban" rows="5" required placeholder="Tuliskan jawaban lengkap di sini..." class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring focus:ring-green-200 shadow-sm">{{ old('jawaban') }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="number" name="urutan" value="{{ old('urutan', $nextUrutan) }}" min="1" required class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring focus:ring-green-200 shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="text" name="kategori" value="{{ old('kategori') }}" placeholder="Contoh: Pendaftaran" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring focus:ring-green-200 shadow-sm">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="status" required class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring focus:ring-green-200 shadow-sm">
                                <option value="aktif">Aktif (Tampilkan di Publik)</option>
                    ...
                    <div class="flex justify-end gap-3 mt-8 border-t pt-5">
                        ...
                        <button type="submit" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2.5 px-6 rounded-lg shadow-sm transition-transform transform hover:-translate-y-0.5 text-sm">Simpan FAQ</button>
                    </div>
                </form>
            </div>
        </div>
